...
import { THEMES, type Theme, useTheme } from 'nyxis-ui/theme';
...
/**
 * Five-mode theme switcher. Reads / writes the active theme through the
 * `useTheme` hook from `nyxis-ui/theme` so it stays in sync with the
 * page's FOUC-prevention script and other toggles in the tab.
 */
